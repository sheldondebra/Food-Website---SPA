...
const Navbar = () => {
  ...
  return (
    <div className=" mx-auto flex justify-between items-center p-4 fixed z-50 bg-white shadow-sm w-full">
      {/* Left side */}
      ...
      {/* Cart button */}
      <button className="bg-black text-white hidden md:flex items-center py-2 rounded-full hover:bg-orange-500 hover:duration-0.3s">
